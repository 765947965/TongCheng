...
public class RedPacketFragment extends BaseFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, RedListAdapter.RedListAdapterSetDialog {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_red_packet_layout, null);
        initView(view);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.llt_rechage_remark:
                String url = "http://user.8hbao.com/usercenter/mobile_chargelog.php?phone=" + TCApplication.getmUserInfo().getPhone() + "&uid=" + TCApplication.getmUserInfo().getUid();
