        ...
        switch (msg.what) {
            case 10001:
                ...
                if (mShareTipsModel != null && !TextUtils.isEmpty(mShareTipsModel.getContent())) {
                    ...
                    mViewHolder.setText(R.id.tv_share_num, Html.fromHtml("<u>分享邀请成功" + mShareTipsModel.getInvite_success_num() + "人</u>"));
                }
                break;
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_share_num://分享人数
                String url = "http://user.8hbao.com:8060/my_invite_list.php?uid=" + TCApplication.getmUserInfo().getUid() + "&sign=" + MD5.toMD5(TCApplication.getmUserInfo().getUid() + Common.SIGN_KEY);
