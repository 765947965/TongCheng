...
public class HttpUrls {
    ...
    public static final String LodingOut_V2 = "http://mobile.8hbao.com:8899/v2/logout_v2";//登出
    ...
    public static final String getMoneyInfo = "http://pay.8hbao.com/recharge/service/accountinfo.php";//查询余额
    public static final String carlist = "http://pay.8hbao.com/recharge/service/wallet_banklist.php";//获取卡列表
    public static final String changecard = "http://pay.8hbao.com/recharge/service/set_bankdefault.php";//改变银行卡
    public static final String deletecard = "http://pay.8hbao.com/recharge/service/delete_wallet_bank.php";//删除银行卡
    public static final String bandingCard = "http://pay.8hbao.com/recharge/service/set_wallet_bank.php";//绑定银行卡
    public static final String moneyout = "http://pay.8hbao.com/recharge/service/cash_apply_plus.php";//提现
    public static final String rechage = "http://pay.8hbao.com/recharge/service/goodsinfo.php";//充值信息
    ...
    public static final String moneyoutList = "http://pay.8hbao.com/recharge/service/cashlist.php";//提现记录
    public static final String ShareTips = "http://user.8hbao.com/share_instructions.php";//提现记录
    ...
    public static final String tixianxianqing = "http://pay.8hbao.com/recharge/service/cashinfo.php";//提现详情
