...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
	...
	@Override
	protected MagicScrollView createRefreshableView(Context context, AttributeSet attrs) {
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			scrollView = new InternalScrollViewSDK9(context, attrs);
		} else {
			scrollView = new MagicScrollView(context, attrs);
		}
	...
	@TargetApi(9)
	final class InternalScrollViewSDK9 extends MagicScrollView {
