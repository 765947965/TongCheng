...
public class LoopViewPager extends ViewPager {
	...
	private OnPageChangeListener onPageChangeListener = new OnPageChangeListener() {
		...
		public void onPageSelected(int position) {
			...
			if (mLoopPagerChangeListener != null) {
				mLoopPagerChangeListener.pagerChanger(realPosition);
			}
		}
	...
	public void setLoopPagerChangeListener(LoopPagerChangeListener mLoopPagerChangeListener) {
		this.mLoopPagerChangeListener = mLoopPagerChangeListener;
	}

	public interface LoopPagerChangeListener {
		public void pagerChanger(int position);
	}
